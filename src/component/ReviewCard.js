          ...
          <View style={{ flex: 8, justifyContent: 'center', paddingRight: 5 }}>
            <TouchableOpacity onPress={() => this.props.navigation.navigate("ReviewDetail")}>
              ...
              <View style={{ flexDirection: 'row' }}>
                <Text style={{ fontSize: 16, color: '#282828' }} numberOfLines={1}>{this.props.cardUsername} - </Text>
                <Text style={{ fontSize: 16, color: '#282828' }} numberOfLines={1}>{this.props.cardViews}</Text>
              </View>
              <Text style={{ fontSize: 16, color: '#282828' }} numberOfLines={1}>{this.props.cardTime}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
